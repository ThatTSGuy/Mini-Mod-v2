...
client.on('message', msg => {
    ...
    if (msg.content.startsWith(config.prefix)) {
        ...
        if (command == 'ping') {
            ...
            embed.setColor(0x4287f5);
            msg.channel.send(embed);
        } else if (command == 'add' && msg.member.roles.cache.find(role => role.name == 'Bot Master')) {
        ...
        } else if (command == 'purge' && msg.member.roles.cache.find(role => role.name == 'Bot Master')) {
            if (args[0] > 100) {
                msg.delete();
        ...
        } else if (command == 'kill' && msg.member.roles.cache.find(role => role.name == 'Bot Master')) {
